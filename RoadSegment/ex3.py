##EDIT BISENET - RIP OFF DOWN 1/32
import os 
import torch
import numpy as np
...
class BiSeNet(nn.Module):
    ...
    def forward(self, x_input):
        ...
        print('sp_out', sp_out.size())
        
        # Context path output
        feature2, feature3, tail = self.context_path(x_input)
        
        # apply attention refinement module 
        feature2, feature3 = self.arm1(feature2), self.arm2(feature3)
        
        # Combine output of lightweight model with tail 
        feature3 = torch.mul(feature3, tail)
        ...
        context_out = torch.cat((feature2, feature3), dim=1)
        print('context_out', context_out.size())
        ...
        if self.training is True:
            feature2_sup = self.supervision1(feature2)
            feature3_sup = self.supervision2(feature3)
            ...
            return bisenet_out, feature2_sup, feature3_sup
        return bisenet_out
